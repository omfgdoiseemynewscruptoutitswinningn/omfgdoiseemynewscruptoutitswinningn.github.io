...
local babababbaba_c = utility:Create("ScrollingFrame", {
    Name = Tab_Name,
...
function makey_vestra:button(btn_title,callback)
...
function makey_vestra:label(lbl_title)
...
function makey_vestra:dropdown(drop_title,list,callback)
...
function makey_vestra:toggle(tgl_title,default,callback)
...
function makey_vestra:colourpicker(clr_title,default,callback)
...
function makey_vestra:slider(stn_title, min, max ,start ,callback)
...
function makey_vestra:keybind(key_title,default,callback)
...
function makey_vestra:textbox(txt_title,default,callback)
